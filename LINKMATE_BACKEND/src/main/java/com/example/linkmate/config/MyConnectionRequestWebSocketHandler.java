...
@Component
public class MyConnectionRequestWebSocketHandler extends TextWebSocketHandler {

    private final ConnectionService connectionService;
    private final Map<String, WebSocketSession> sessions = new HashMap<>();

    public MyConnectionRequestWebSocketHandler(ConnectionService connectionService) {
